...
it('can add the star name and star symbol properly', async() => {
    ...
    let user2 = accounts[2];
    let starId = 666;
    await instance.createStar('starrrr', starId, {from: user1});
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    let user1 = accounts[1];
    let starId = 998;
    let starName = 'starrrr'
    await instance.createStar(starName, starId, {from: user1});
    let starNameFromContract = await instance.lookUptokenIdToStarInfo(starId);
    assert.equal(starNameFromContract, starName);
});